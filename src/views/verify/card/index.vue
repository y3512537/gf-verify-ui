    ...
    <el-card shadow="always">
      <el-form :model="state.queryParams" ref="queryFormRef" :inline="true">
        <el-form-item label="软件名称" prop="softwareName">
          <el-select v-model="state.queryParams.softwareId" clearable placeholder="please select a software"
                     size="default">
      ...
      <el-row :gutter="10" custom-class="mb8">
        ...
        <el-col :span="1.5">
          <el-button size="default" type="primary" @click="onClickDownload">
            <el-icon>
              <ele-Download/>
            </el-icon>
            下载导入模板
...
import {listCard, delCard, quickRechargeCard, freezeCard, unbindCard,downloadCardTemplate} from '/@/api/verify/card';
...
const onClickDownload = async () => {
  let res = await downloadCardTemplate()
  Download.excel(res,"Card_Import_Template.xlsx")
}
